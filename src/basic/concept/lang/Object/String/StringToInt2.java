...
public class StringToInt2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n1. String to Int ============>");
		String s_num = "10";
		int i_num  = Integer.parseInt(s_num); // 1번 방식
		int i_num2 = Integer.valueOf(s_num);  // 2번 방식
		...
		System.out.println("\n1. Int to String  ============>");
		int i_num21 = 21;
		String s_num21   = String.valueOf(i_num21);   // 1번 방식
		String s_num211  = Integer.toString(i_num21); // 2번 방식
		String s_num2111 = ""+i_num21;                // 3번 방식
